...
export function NumeracyPracticesTable() {
  // Group by state for display
  const groupedData = numeracyPracticeData.reduce((acc, district) => {
    ...
    return acc;
  }, {} as Record<string, { stateName: string; districts: typeof numeracyPracticeData }>);
    ...
    <section className="animate-slide-up" style={{ animationDelay: '0.3s' }}>
      <div className="mb-4">
        ...
        <p className="text-sm text-muted-foreground mt-1">
          District-wise performance on numeracy teaching practices
        </p>
        <div className="flex flex-wrap gap-2 mt-3">
          <Badge variant="outline" className="text-xs">PP1: Concrete Materials</Badge>
          <Badge variant="outline" className="text-xs">PP2: Real-life Experiences</Badge>
          <Badge variant="outline" className="text-xs">PP3: Practice Opportunities</Badge>
          <Badge variant="outline" className="text-xs">PP4: Explain Solutions</Badge>
                  ...
                  {districts.map((district) => (
                    <TableRow key={district.districtId} className="hover:bg-table-hover transition-colors">
                      ...
                      <TableCell className="text-center">
                        <StatusCell value={district.pp1} kpiId="num_pp1" stateId={district.stateId} districtId={district.districtId} />
                      </TableCell>
                      <TableCell className="text-center">
                        <StatusCell value={district.pp2} kpiId="num_pp2" stateId={district.stateId} districtId={district.districtId} />
                      </TableCell>
                      <TableCell className="text-center">
                        <StatusCell value={district.pp3} kpiId="num_pp3" stateId={district.stateId} districtId={district.districtId} />
                      </TableCell>
                      <TableCell className="text-center">
                        <StatusCell value={district.pp4} kpiId="num_pp4" stateId={district.stateId} districtId={district.districtId} />
                      </TableCell>
                      <TableCell className="text-center">
                        <StatusCell value={district.gp1} kpiId="num_gp1" stateId={district.stateId} districtId={district.districtId} />
                      </TableCell>
                      <TableCell className="text-center">
                        <StatusCell value={district.gp2} kpiId="num_gp2" stateId={district.stateId} districtId={district.districtId} />
                      </TableCell>
                    </TableRow>
                  ))}
                </>
